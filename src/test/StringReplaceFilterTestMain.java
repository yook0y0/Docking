...
public class StringReplaceFilterTestMain {

	public static void main(String[] args) throws Exception{
		long before = System.currentTimeMillis();
		System.out.println(before);
		
		DockingAnalyzer ds = new StringReplaceFilter(new FileUnzipFilter(new FilePathRegister(Attr.TEST_ZIPFILE_LOCAL_PATH)),".","fwefe");
		ds.analyze();
