			...
			<c:choose>
				...
				<c:otherwise>
					...
					<li style="margin: 5% -5%">
						<div class="btn-group">
							<button type="button" class="btn btn-theme dropdown-toggle"
								data-toggle="dropdown"><c:out value="${sessionScope.logInMember.memberId}"></c:out><span class="caret"></span>
							</button>
							<ul class="dropdown-menu" role="menu">
								<li>MY INFO</li>
								<li class="divider"></li>
								<li><a onclick="memberSearch()">UPDATE</a></li>
								<li><a onclick="memberDelete()">DELETE</a></li>
...
<aside>
	<div id="sidebar" class="nav-collapse ">
		...
		<ul class="sidebar-menu" id="nav-accordion">
			...
			<li class="sub-menu"><a onclick='getCont("list_editor")'> <i
...
<footer class="site-footer">
	<div class="text-center">
		2014 - Docking <a href="dStart.html#" class="go-top"> <i
